...
<html>
 ...
 <ul class="nav nav-tabs nav-justified">
  <li class="active"><a data-toggle="tab" href="#menu0">Account</a></li>
  <li><a data-toggle="tab" href="#menu1">Filters</a></li>
     </br>
...
<br><input type="range" name="rangeRange" min="0.1" max="5" step="0.1" value="<?php echo $rangeRange;?>" onchange="updateRangeOutput(this.value);">
																	<br>
        <span style="color:#F39200";>Butget:</span> <span id="budgetOutput" class="rangeOutputDiv"><strong><?php echo $budgetRangeOutp;?></strong></span>
																		<br>
        <input type="range" name="budgetRange" min="1" max="3" step="1" value="<?php echo $budgetRange;?>" onchange="updateBudgetOutput(this.value);">
